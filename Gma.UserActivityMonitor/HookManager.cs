...
namespace Gma.UserActivityMonitor
{
    ...
    public static partial class HookManager
    {
        ...
        private static event MouseEventExtHandler s_MouseMove;

        /// <summary>
        /// Occurs when the mouse pointer is moved. 
        /// </summary>
        public static event MouseEventExtHandler MouseMove
        {
            add
            {
        ...
        private static event MouseEventExtHandler s_MouseMoveExt;
        ...
        /// </remarks>
        public static event MouseEventExtHandler MouseMoveExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static event MouseEventExtHandler s_MouseClick;

        /// <summary>
        /// Occurs when a click was performed by the mouse. 
        /// </summary>
        public static event MouseEventExtHandler MouseClick
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static event MouseEventExtHandler s_MouseClickExt;
        ...
        /// </remarks>
        public static event MouseEventExtHandler MouseClickExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </summary>
        public static event MouseEventExtHandler MouseDown
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static event MouseEventExtHandler s_MouseUp;

        /// <summary>
        /// Occurs when a mouse button is released. 
        /// </summary>
        public static event MouseEventExtHandler MouseUp
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static event MouseEventExtHandler s_MouseWheel;

        /// <summary>
        /// Occurs when the mouse wheel moves. 
        /// </summary>
        public static event MouseEventExtHandler MouseWheel
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static event MouseEventExtHandler s_MouseDoubleClick;
        ...
        /// </summary>
        public static event MouseEventExtHandler MouseDoubleClick
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static void OnMouseUp(object sender, MouseEventExtArgs e)
        {
